...
class Snippet extends React.Component {
  ...
  render() {
    return (
      <Button bsStyle="primary" id={this.props.id} onClick={this.myClick}>
        Snippet {this.props.id}{" "}
      </Button>
    );
  }
  myClick(e) {
...
class Menubar extends React.Component {
  render() {
    return (
      <div>
        <Button bsStyle="primary" id="AAA" onClick={this.myClick}>
          Primary
        </Button>

        <DropdownButton title="ABC" key="S" id="MYIF">
          <MenuItem eventKey="1" onClick={this.myClick}>
            Action
          </MenuItem>
